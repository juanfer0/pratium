...
public class UserRecord extends javax.swing.JFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            String sql = "seleccione * de Registro donde usuario_nombre= '" + table_click + "'";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                this.hide();
                ...
                ob1.setVisible(true);
                String add1 = rs.getString("usuario_nombre");
                ob1.txtUsername.setText(add1);
                String add2 = rs.getString("contraseña");
                ob1.jPassword.setText(add2);
                String add3 = rs.getString("nombre");
                ob1.txtName.setText(add3);
                String add4 = rs.getString("numero de contacto");
