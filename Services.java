...
PreparedStatement pst=null;
 ...
 private void Get_Data1(){
      try{
        ...
        String sql="seleccione PacienteID como 'Paciente ID',Nombre del Paciente como 'Nombre del Pacienete' de Registro del Paciente ordenado por Nombre del Paciente";
...
{   
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Cargos por servicio ");
        ...
        txtGetData.setText("Obtener datos");
    ...
    private void txtSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSaveActionPerformed
        try{
            ...
            if (txtServiceDate.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Ingrese fecha del sevicio");
                return;
            }
            if (txtPatientID.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Psleccione paciente id");
                return;
            }
            if (txtServiceCharges.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Seleccione CAMbios de servicio");
                return;
            }

            String sql= "inserte en Servicios(Nombre del ServicioFechadel Servicio,PacienteID,Cmabios del Servicio)valores('"+ txtServiceName.getText() + "','"+ txtServiceDate.getText() + "','" + txtPatientID.getText() + "'," + txtServiceCharges.getText() + ")";
            pst=con.prepareStatement(sql);
            pst.execute();
    ...
    private void txtDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDeleteActionPerformed
        try{
            int P = JOptionPane.showConfirmDialog(null," Desea elminar ?","Confirme",JOptionPane.YES_NO_OPTION);
            if (P==0)
            {
                con=Connect.ConnectDB();
                String sql= "eliminar de ser4vicios donde ServicioID = " + txtServiceID.getText() + "";
                pst=con.prepareStatement(sql);
                pst.execute();
    ...
    private void txtUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtUpdateActionPerformed
        try{
            con=Connect.ConnectDB();
            String sql= "actualizar servicios set Nombre del Servicio='" + txtServiceName.getText() +"',Fecha del Servicio='" + txtServiceDate.getText()+ "',PacineteID='" + txtPatientID.getText() + "',Cambios del Servicio='" + txtServiceCharges.getText() + "' donde ServicioID='" + txtServiceID.getText() + "'";
            pst=con.prepareStatement(sql);
            pst.execute();
