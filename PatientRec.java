...
private void Get_Data(){
           String sql="seleccione PacienteID como 'Paciente ID', Nombre del Paciente como 'Nombre del Paciente',Nombre del Padre como'Nombre del Padre',Direccion,numero de contacto como 'numero de contacto',Email as 'Email ID',Edad,Genero como 'Genero',BG como 'Grupo Sanguineo',Observaciones de Raegistro de Pacientes";
           try{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try{
            ...
            String sql= "selecuione * de Registro del Pacioente donde Paciente ID = '" + table_click + "'";
            pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
                this.hide();
                ...
                String add15=rs.getString("Direccion");
                frm.txtAdd.setText(add15);
                String add16=rs.getString("Numero de Contacto");
