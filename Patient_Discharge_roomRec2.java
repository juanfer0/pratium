    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            ...
            if(rs.next()){
                ...
                String add3=rs.getString("Paciente ID");
                frm.PatientID.setText(add3);
                String add5=rs.getString("Nombre del Paciente");
                ...
                String add18=rs.getString("Fecha de Descarga");
                frm.txtDischargeDate.setText(add18);
                int add22 = rs.getInt("Cambios de Cuarto");
