...
public class Patient_Discharge_roomRec1 extends javax.swing.JFrame {
 ...
 private void Get_Data(){
         try{
         String sql="Seleccione Registro de Paciente.PacienteID como 'Paciente ID',Registro de Paciente.Nombre de Paciente como 'Nombre de Paciente',Registro de Paciente.Genero como 'Genero',Registro de Paciente.BG como 'Grupo Sanguineo',Enfermedad,Fecha de Descarga como 'Fecha de Admicion',Cuarto.Numero de Cuarto 'Numero de Cuarto',Doctor.DoctorID as 'Doctor ID',Nombre de Doctor como 'Nombre de Doctor',AdmitPatient_Cuarto.AP_Observaciones como 'Observaciones' de Cuarto,Doctor,Registro de Paciente,AdmitPatient_Cuarto donde Cuarto.Numero de Caurto=AdmitPatient_Cuarto.Numero de Cuarto y Doctor.DoctorID=AdmitPatient_Cuarto.DoctorID y Registro de Paciente.PatientID=AdmitPatient_Cuarto.PacienteID ordenado por Fecha de Descarga";
